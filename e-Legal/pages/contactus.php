<?php
  ...
  if(isset($_POST["submit"]))
  {
    ...
    $query= strip_tags(stripcslashes(trim($_POST["query"])));
    ...
    $sql = "INSERT INTO queries (name,email,query) VALUES ('".$name."','".$_SESSION["email"]."','".$query."');";

    if(mysqli_query($conn,$sql) === TRUE)
    {
      echo "<script>
              alert('Your Query Successfully submitted. We will get back to you shortly.');
...
<div class="wrapper row3">
  ...
  <div style="width: 120px; height: 200px; float: left;">
    Name:<br><br><br>   
    Enter your query:<br><br><br><br><br>
  </div>

  <div style="width: 500px; height: 200; float: left;">
    <input type="text" value="" name="name" style="border-radius: 7px; background-color:#06213f; color: white; height: 30px; width:293px;  " required=""></input><br>
    <textarea rows="10" cols="40" name="query" style="background-color:#06213f; color: white; " required=""></textarea><br><br>

    <input type="submit" value="Submit" name="submit" style="background-color: #06213f; border-radius: 5px; color: white; height: 30px; width: 70px; margin-left: 80px;"></input>
  </div>
  </form>
  </main>
  </div>
      ...
      <div class="one_third">
        ...
        <form class="clear" method="post" action="newsletter.php">
          <fieldset>
            ...
            <button class="fa fa-sign-in" name="submit" type="submit" onclick="newsletter.php" title="Sign Up"><em>Sign Up</em></button>
          </fieldset>
        </form>
      </div>
    </footer>
